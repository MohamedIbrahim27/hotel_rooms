# Generated by Django 4.2 on 2023-06-18 03:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='allauth.socialaccount')),
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='allauth.socialapp')),
            ],
            options={
